...
export class AddSomeUrls1557761316509 {
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "meta" ADD "repositoryUrl" character varying(512) NOT NULL DEFAULT 'https://github.com/Evgen0922/speechka_develop'`);
        await queryRunner.query(`ALTER TABLE "meta" ADD "feedbackUrl" character varying(512) DEFAULT 'https://github.com/Evgen0922/speechka_develop/issues/new'`);
    }
