...
<div class="dkgtipfy" :class="{ wallpaper }">
	...
	<div v-if="isMobile" class="buttons">
		<button class="button nav _button" @click="drawerMenuShowing = true"><i class="fas fa-bars"></i><span v-if="$i != null && $i.hasPendingReceivedFollowRequest" class="indicator"><i class="fas fa-circle"></i></span></button>
		<button class="button notifications _button" @click="mainRouter.push('/my/notifications')"><i class="fas fa-bell"></i><span v-if="$i != null && $i.hasUnreadNotification" class="indicator"><i class="fas fa-circle"></i></span></button>
		...
		<button class="button widget _button" @click="mainRouter.push('/my/messaging')"><i class="fas fa-comments"></i><span v-if="$i != null && $i.hasUnreadMessagingMessage" class="indicator"><i class="fas fa-circle"></i></span></button>
